...
struct ModelsConfig {
    ...
    static let supportedModels: [ModelInfo] = [
        ...
        ModelInfo(
            ...
            url: "https://huggingface.co/argmaxinc/whisperkit-coreml/tree/main/openai_whisper-medium.en"
        ),
        ModelInfo(
        ...
        ModelInfo(
            ...
            url: "https://huggingface.co/argmaxinc/whisperkit-coreml/tree/main/openai_whisper-small.en_217MB"
        ),
        ModelInfo(
